...
The second/hidden layer contains sigmoid neurons, who sum the input of their synapses and apply the function (1 / 1 + e^k), which results in a new output in the range of (-1, 1).
